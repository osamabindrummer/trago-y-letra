# Encargo Terra 17 — promover Literary Libations
...
Revisar y promover al catálogo canónico todos los resultados Luna correspondientes a Literary Libations. Los libros ya están aceptados como fuentes secundarias reputadas. No rechaces una propuesta sólo por confianza baja, perfil mínimo, obra mínima o bebida de servicio directo.
...
- Cada recomendación debe conservar una evidencia con `source_id: fuente-literary-libations` y localizador.
