# Encargo Luna 02 — Literary Eats, lote 02
...
- `hallazgo-three-books-015` — Walker Percy — Cud’n Walker’s Uncle Will’s Favorite Mint Julep Receipt
- `hallazgo-three-books-016` — Kenneth Roberts — Hot Buttered Rum
- `hallazgo-three-books-017` — Theodore Roosevelt — Mint Julep — Kentucky Style
- `hallazgo-three-books-018` — Lydia Sigourney — Cordials
- `hallazgo-three-books-019` — Bayard Taylor — Gothic Punch
- `hallazgo-three-books-020` — Mark Twain — German Coffee
- `hallazgo-three-books-021` — Mark Twain — Whiskey and Bitters
- `hallazgo-three-books-022` — Robert Penn Warren — Insidious Punch
- `hallazgo-three-books-023` — George Washington — Small Beer
- `hallazgo-three-books-024` — Daniel Webster — Punch
- `hallazgo-three-books-027` — Bobbie Ann Mason — Boiled Custard
