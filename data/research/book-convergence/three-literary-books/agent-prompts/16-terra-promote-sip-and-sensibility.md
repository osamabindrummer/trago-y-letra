# Encargo Terra 16 — promover Sip and Sensibility
...
Revisar y promover al catálogo canónico todos los resultados Luna correspondientes a Sip and Sensibility. Los libros ya están aceptados como fuentes secundarias reputadas. No rechaces una propuesta sólo por confianza baja, perfil mínimo, obra mínima o bebida de servicio directo.
...
- Cada recomendación debe conservar una evidencia con `source_id: fuente-sip-and-sensibility` y localizador.
